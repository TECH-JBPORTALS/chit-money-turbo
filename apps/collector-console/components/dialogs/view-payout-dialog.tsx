...
export function ViewPayoutDialog({ children }: { children: React.ReactNode }) {
  return (
    <Dialog>
              ...
              <div className="space-y-2">
                ...
                <div className="px-3 rounded-lg bg-muted/15 space-y-2 py-5">
                  <div className="inline-flex justify-between w-full">
                    ...
                    <p className="text-sm text-right">₹1,00,000</p>
                  </div>
                  <div className="inline-flex justify-between w-full">
                    <small className="text-muted-foreground text-sm">
                      {"Your Commission (2%)"}
                  ...
                  <div className="inline-flex justify-between w-full">
                    ...
                    <p className="text-sm font-bold text-right">₹98, 200</p>
                  </div>
                </div>
              </div>
