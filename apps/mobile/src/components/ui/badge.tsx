...
const badgeVariants = cva(
  "web:inline-flex items-center rounded-xl border border-border px-2.5 py-0.5 web:transition-colors web:focus:outline-none web:focus:ring-2 web:focus:ring-ring web:focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
        ...
        outline: "text-foreground bg-input",
      },
    },
    defaultVariants: {
      variant: "default",
