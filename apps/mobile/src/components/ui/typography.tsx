  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        className={cn(
          "mt-6 native:mt-4 border-l-2 border-border font-normal pl-6 native:pl-3 text-base text-foreground italic web:select-text",
          className
        )}
        ref={ref}
        {...props}
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        className={cn(
          "relative rounded-md px-[0.3rem] py-[0.2rem] font-fira text-sm text-foreground font-semibold web:select-text",
          className
        )}
        ref={ref}
        {...props}
...
const Lead = React.forwardRef<TextRef, SlottableTextProps>(
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        className={cn(
          "text-xl text-muted-foreground font-normal web:select-text",
          className
        )}
        ref={ref}
        {...props}
...
const Muted = React.forwardRef<TextRef, SlottableTextProps>(
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        className={cn(
          "text-sm text-muted-foreground font-normal web:select-text",
          className
        )}
        ref={ref}
        {...props}
